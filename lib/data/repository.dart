...
class NoeticaRepository {
  ...
  /// Wipe every synced local table. Used when the backend user changes —
  /// we drop the previous user's local cache so data cannot bleed between
  /// isolated sessions/users.
